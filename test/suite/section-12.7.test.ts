// TEST-SPEC §12.7 (SUITE-58): thin Vitest wrapper over the registered
...
import { section127Tests } from "./registry/section-12.7.js";

declareProductTests(section127Tests);
